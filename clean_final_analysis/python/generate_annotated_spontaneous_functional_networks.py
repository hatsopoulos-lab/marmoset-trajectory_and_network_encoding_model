...
nwb_outfile = nwb_infile.parent / f'{nwb_infile.stem}_annotated_chewingFiltered{nwb_infile.suffix}'    

frates_outfile = nwb_infile.parent / f'{nwb_infile.stem}_annotated_chewingFiltered_average_firing_rates.pkl' 
...
def create_binarized_rasters(units, reaches, kin_module, nwb, chew_df, mode):
...
def compute_average_firing_rates(reach_raster_list, spontaneous_raster_list, behavior_dict):
...
if __name__ == "__main__":
    ...
    with NWBHDF5IO(nwb_infile, 'r') as io_in:
        ...
        compute_average_firing_rates(reach_raster_list, spontaneous_raster_list, annotated_behavior_dict)
