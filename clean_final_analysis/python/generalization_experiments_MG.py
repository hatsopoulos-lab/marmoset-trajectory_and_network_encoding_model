...
if __name__ == "__main__":
    ...
    models_dict = {'full_vs_spont_FN' : {'model_names'           : [     'kin_model_spont_train_reach_test_FN',     
                                         ...
                                         'FN'                    : [spontaneous_FN.copy(), 
                                                                    ...
                                                                    annotated_FN_dict['Locomotion'].copy(),
                                                                    annotated_FN_dict['Arm_movements'].copy()],
                                         'FN_key'                : ['spontaneous_FN', 'rest', 'locomotion', 'arm_movements'],
                                         'test_FN'               : [reach_FN.copy(),
                                                                    reach_FN.copy(),
                                                                    reach_FN.copy(),
                                                                    reach_FN.copy()],
                                         'test_FN_key'           : ['reach_FN', 'reach_FN', 'reach_FN', 'reach_FN'],
