...
if __name__ == "__main__":
    ...
    if debugging:
        ...
        n_tasks = params.num_models_including_shuffles
    else:
    ...
    if n_tasks != n_tasks_needed and not debugging and not demo:
        ...
        task_list = range(n_tasks) if demo else [task_id]
