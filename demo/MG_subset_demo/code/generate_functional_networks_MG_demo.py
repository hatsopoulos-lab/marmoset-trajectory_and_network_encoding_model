...
nwb_outfile = nwb_infile.parent / f'{nwb_infile.stem}_with_functional_networks{nwb_infile.suffix}'    

frates_outfile = nwb_infile.parent / f'{nwb_infile.stem}_average_firing_rates.h5' 
...
def compute_average_firing_rates(reach_raster_list, spontaneous_raster_list):
    ...
    average_frates.to_hdf(frates_outfile, 'average_rates')
