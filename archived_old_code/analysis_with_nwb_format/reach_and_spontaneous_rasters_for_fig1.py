...
if marmcode == 'TY':
    ...
    reaches_to_plot=[14]  #[42, 43, 44, 45, 46, 47]
...
def generate_event_raster(units, units_res, reaches, preTime=1, postTime=1, 
    ...
    fig0, ax0 = plt.subplots(figsize=figsize, dpi=300)    
...
if __name__ == '__main__':
    ...
    with NWBHDF5IO(nwb_analysis_file, 'r') as io:
        ...
        plot_fig1_trajectory_sampling(units_res, reaches, reachNum = reaches_to_plot[0], 
                                      ...
                                      modulation_palette = plot_params.modulation_palette)    
